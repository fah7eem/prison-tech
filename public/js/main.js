...
var _constantStrings = require('../common/utils/constantStrings.json');
...
$(document).ready(function () {
  ...
  window.Mousetrap.bind('g n a', function () {
    // About
    window.location = _constantStrings.aboutUrl;
  });
  window.Mousetrap.bind('g n d', function () {
    // Donate
    window.location = _constantStrings.donateUrl;
  });
